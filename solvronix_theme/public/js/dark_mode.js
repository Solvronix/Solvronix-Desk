...
function stSetDark(on) {
  ...
  if (frappe && frappe.session && frappe.session.user !== "Guest") {
    frappe.call({
      method: "solvronix_theme.api.set_user_theme",
...
function stInjectDarkToggle() {
  ...
  if (existing) {
    /* Button already created by solvronix_theme.js in the correct position —
...
$(document).ready(function () {
  ...
  /* Wait for our toolbar to be injected by solvronix_theme.js,
