...
web_include_css = ["/assets/solvronix_theme/css/login.css?v=5"]
web_include_js = ["/assets/solvronix_theme/js/login_theme.js?v=2"]

app_include_css = [
    "/assets/solvronix_theme/css/solvronix_theme.css?v=32",
    ...
    "/assets/solvronix_theme/css/notification_center.css?v=3",
...
app_include_js = [
    ...
    "/assets/solvronix_theme/js/solvronix_theme.js?v=26",
